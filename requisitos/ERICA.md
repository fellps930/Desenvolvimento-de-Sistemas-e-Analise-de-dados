...
Verificação lançamento da chamada - Detectar automaticamente se professor não lançou chamada até 20 horas após término de aula e gerar alerta para coordenador. Permitir que o coordenador solicite ao professor o lançamento via notificação (WhatsApp/e-mail)

Calculo de horas aulas e disponibilidade do professor - Calcular horas-aula por disciplina/professor no período semana/mês com base em horários e lançamentos.

Organização das disciplinas e professores - Interface para mapear disciplinas a professores, com sugestões automáticas baseadas em disponibilidade e carga horária. E bloquear automaticamente que exceda carga máxima do professor.
...
Usabilidade / UX - Coordenador consegue executar as 5 tarefas críticas em ≤ 3 cliques.
Fornecer UI limpa, responsiva, suporte a dispositivos móveis e desktop. Acessibilidade

Performance -
Dashboard: carregar em ≤ 2s para bases de até 3.000 alunos.
...
Mecanismo de reconciliação com SIGA e arquivos CSV.
